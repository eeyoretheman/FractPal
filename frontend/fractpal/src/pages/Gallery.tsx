            ...
            <section className="gallery-section">
              ...
              <div className="fractals-grid">
                {drafts.map(f => (
                  <FractalCard
                    key={f.id}
                    fractal={{ id: f.id, name: f.name, username: f.username, userId: f.userId, imageUrl: f.imageUrl, likeCount: f.likeCount, isLikedByCurrentUser: f.isLikedByCurrentUser, createdAt: f.createdAt }}
                    isPosted={false}
                    showActions
